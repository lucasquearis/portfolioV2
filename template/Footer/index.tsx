...
export default function Footer() {
  return (
    <footer className="flex h-auto min-h-[70px] flex-col justify-center gap-4 bg-primary-background-primary fill-primary-text-navy-navy p-4 text-center text-sm text-primary-text-navy-navy">
      <Bounce bottom>
        <div className="flex w-full justify-center gap-5 after:bg-primary-text-navy-navy md:fixed md:right-auto md:left-5 md:bottom-0 md:z-10 md:w-10 md:flex-col md:after:my-0 md:after:mx-auto md:after:h-24 md:after:w-[1px]">
          <a
